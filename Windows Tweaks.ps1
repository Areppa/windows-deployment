<#
This script will make windows tweaks without user interaction

Before running this script I would HIGHLY RECOMMEND to check the contents of this script and modify it to your needs
- This script has been adjusted to my preferences and might not be suitable for everyone

Parts of the code have been copied from https://github.com/ChrisTitusTech/winutil
#>

Write-Output "This script will adjust some Windows settings, services and uninstall bloatware`n"


###############################################################################################################################################################
#                                                                                                                                                             #
#                                                             CHECK & ASK FOR ADMINISTRATOR ACCESS                                                            #
#                                                                                                                                                             #
###############################################################################################################################################################
...
# Wait for key press
Write-Output "`nNow you need to restart your computer to make changes active"
